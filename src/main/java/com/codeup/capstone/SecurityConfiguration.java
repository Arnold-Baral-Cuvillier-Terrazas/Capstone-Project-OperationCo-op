...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/", "/posts","/profile/bio") // Another Neat Tool matcher - if someone hits these URLs in their browser (i.e. http://localhost:8080/ads) they are allowed to view, even if not logged in
